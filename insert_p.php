				...
				<div class="row">
					 ...
					 <form role="form" method="post" enctype="multipart/form-data" action="insert_p.php">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="p_name" required="required">
							...
							<div class="form-group">
                                ...
                                <textarea class="form-control" name="p_desc" rows="10" cols="15" required="required"></textarea>
                                <p class="help-block"></p>
                            </div>
...
if(isset($_POST['insert'])){
	...
	if($cat == "null" || $brand =="null"){
		...
		$insert = "insert into product(p_name,p_category,p_sub,p_brand,p_price,p_desc,qty,p_image) VALUES('$name','$cat','$sub','$brand','$price','$desc','$qty','$image')";
