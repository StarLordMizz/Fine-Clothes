...
if(isset($_POST['register'])){
	...
	if (empty($uname AND $email AND $pass AND $c_pass)) {
	...
	alert('Password not matched') </script>";
		...
		$insert_user = "insert into customer(c_session,c_name,c_email,c_pass) VALUES('$cookie_id','$uname','$email','$pass')";
...
?>
	...
	<style>
		.bg-img {
  /* The image used */
  background-image: url("images/home/log.jpg");
