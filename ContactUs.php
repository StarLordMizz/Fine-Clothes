<?php include "inc/header.php"; ?>
	 ...
	 <div id="contact-page" class="container">
    		<div class="bg">
		    	<div class="row"> 
		 	    	<div class="col-sm-12">    			   			
					 	<img src="images/home/cu.png" width="100%">
					</div>
				</div>	
			</div>    	
	    			...
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" action="handler/contact.php"  class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" class="form-control" rows="8" placeholder="Your Message Here" required></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>FineClothes</p>
							<p>Canada</p>
							 <p>Mobile: +15145145141</p>
							<p>Email: fineclothes@tutanota.com</p>
	    				</address>
