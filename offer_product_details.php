			...
			<div class="row">
				...
				<div class="col-sm-12 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Offer Products Details</h2>
						
						<?php
                        if (isset($_GET['pid'])) {
                            $pid = preg_replace('#[^0-9]#i', '', $_GET['pid']);
						$select = "select * from offerproducts where id=$pid";
						...
						<div class='col-sm-12'>
							<div class='product-image-wrapper'>
                                ...
                                <img src='admin/images/$image' alt='' class='img-responsive center-block' height='312px' width='312px' >
                                    ...
                                    <tr><td><h5>Discount : </h5></td> <td> <h2> $ $dprice</h2></td></tr>

                                    <tr><td><h5>Quantity :</h5></td> <td> <h2>$qtyof</h2></td></tr>
