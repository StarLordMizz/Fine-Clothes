 ...
 <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
					 ...
					 <form role="form" method="post" enctype="multipart/form-data" action="insert_offer_products.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="d_price">
                                <p class="help-block"></p>
                            </div>
...
if(isset($_POST['insert'])){
	...
	if($cat == "null" || $brand =="null"){
		...
		echo "<script>window.open('insert_offer_products.php','_self')</script>";
		exit();
	}else if($image==''){
		...
		$mprice=$price-$dprice;
		$insert = "insert into offerproducts(p_name,p_category,p_sub,p_brand,p_price,d_price,m_price,p_desc,qty_o,p_image) VALUES('$name','$cat','$sub','$brand','$price','$dprice','$mprice','$desc','$qty','$image')";
		$run = mysqli_query($con,$insert);
		if($run){
			move_uploaded_file($tmp_image,"images/$image");
			echo "<script>alert('Product inserted Successfully !!')</script>";
		    echo "<script>window.open('view_offer_products.php','_self')</script>";
